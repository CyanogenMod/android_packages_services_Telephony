        ...
        if (carrierConfig.getBoolean(CarrierConfigManager.KEY_HIDE_CARRIER_NETWORK_SETTINGS_BOOL)) {
            ...
            if (phoneType == PhoneConstants.PHONE_TYPE_CDMA) {
                ...
                if (SystemProperties.get("ro.telephony.lte_capable") != null) {
                    if ("1".equals(SystemProperties.get("ro.telephony.lte_capable")) || "true".equals(SystemProperties.get("ro.telephony.lte_capable"))) {
            	        mIsLteCapable = true;
                    } else if ("0".equals(SystemProperties.get("ro.telephony.lte_capable")) || "false".equals(SystemProperties.get("ro.telephony.lte_capable"))) {
                        mIsLteCapable = false;
                    }
                }
                if (isSupportTdscdma()) {
