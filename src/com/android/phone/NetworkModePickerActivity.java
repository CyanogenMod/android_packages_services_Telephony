...
public final class NetworkModePickerActivity extends AlertActivity implements
    ...
    private static final String TAG = "NetworkModePickerActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int[] ev = MobileNetworkSettings.getDeviceNetworkEntriesAndValues(this, mPhone,
                mInitialMode, carrierConfig);
    ...
    public void onClick(DialogInterface dialog, int which) {
        ...
        if (positiveResult) {
            ...
            resultIntent.putExtra(EXTRA_NETWORK_MODE_PICKED,
                    which == DialogInterface.BUTTON_NEUTRAL ? -1 : mNetworkValues[mClickedPos]);
