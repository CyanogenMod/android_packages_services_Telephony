...
public class MSimCallFeaturesSubSetting extends CallFeaturesSetting {
    ...
    protected void onCreate(Bundle icicle) {
        ...
        setPrefenceKeyForSubscription(mVibrateOutgoingPref);
        ...
        setPrefenceKeyForSubscription(mVibrateCallWaitingPref);
        ...
        setPrefenceKeyForSubscription(mVibrateHangupPref);
        ...
        setPrefenceKeyForSubscription(mVibrate45Pref);
        ...
        setPrefenceKeyForSubscription(mShowSSNPref);
