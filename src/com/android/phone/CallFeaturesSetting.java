...
public class CallFeaturesSetting extends PreferenceActivity
    ...
    protected void removeOptionalPrefs(PreferenceScreen preferenceScreen) {
        ...
        PackageManager pm = getPackageManager();
        String phonePackage = "com.android.phone";
        Resources phoneResources;
        boolean recordingEnabled = false;
        try {
            phoneResources = pm.getResourcesForApplication(phonePackage);
            int booleanID = phoneResources.getIdentifier("call_recording_enabled", "bool", phonePackage);
            recordingEnabled = phoneResources.getBoolean(booleanID);
